...
<svg width="${w}" height="${400}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
    <linearGradient id="g">
  ...
  <rect width="${w}" height="${400}" fill="#333" />
  <rect id="r" width="${w}" height="${400}" fill="url(#g)" />
